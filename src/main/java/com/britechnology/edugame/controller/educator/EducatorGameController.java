...
import com.britechnology.edugame.service.educator.GameCoverService;
import com.britechnology.edugame.service.educator.EducatorGameService;
...
public class EducatorGameController {
    ...
    public ResponseEntity<GameDTO> generateCover(@PathVariable Long id) {
        ...
        String coverDataUrl = gameCoverService.generateCoverImageDataUrl(jeu);
        UpdateGameRequest request = new UpdateGameRequest();
        request.setCoverImageUrl(coverDataUrl);
        return ResponseEntity.ok(educatorGameService.updateGame(id, request));
    }
    ...
    public ResponseEntity<Map<String, String>> generateCoverPreview(@RequestBody GenerateCoverPreviewRequest request) {
        Jeu draft = gameCoverService.buildPreviewJeu(request);
        String coverDataUrl = gameCoverService.generateCoverImageDataUrl(draft);
        return ResponseEntity.ok(Map.of("coverImageUrl", coverDataUrl));
    }
